            ...
            <div className="container">
              ...
              <div className="my-3">
                    ...
                    <div className="container p-3">
                      {showSuccessAlert && (
                        <div
                          ...
                          role="alert"
                        >
                          <strong>Thank you!</strong> For submitting your
                          information we will get back to you soon.
                          <button
                            type="button"
                            className="btn-close"
                ...
                <div className="m-3">
                  ...
                  <div
                    className="accordion bg-dark shadow-lg"
                    id="accordionExample"
                  >
                    {faqs.map((faq) => {
                      return (
            ...
            <div className="container d-flex flex-column ">
              ...
              <div className="my-3">
                ...
                <div className="d-flex flex-column justify-content-center align-items-center">
                  ...
                  <div>
                    <h3 className="p-3 mx-3 text-center">
                      <span className="border-bottom ">About {title}</span>
                    </h3>
                    <p className="px-3 mx-3">{about}</p>
                  </div>
